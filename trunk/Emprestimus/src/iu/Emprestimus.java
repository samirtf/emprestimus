...
public class Emprestimus implements EmprestimusIF {
	...
	public String localizarUsuario(String idSessao, String chave, String atributo) throws Exception {
		...
		asserteTrue(autenticacao.existeIdSessao(idSessao), Mensagem.SESSAO_INEXISTENTE
				.getMensagem());
		assertStringNaoVazia(chave, Mensagem.PALAVRA_CHAVE_INVALIDA.getMensagem(),
				Mensagem.PALAVRA_CHAVE_INVALIDA.getMensagem());
		assertStringNaoVazia(idSessao, Mensagem.PALAVRA_CHAVE_INVALIDA.getMensagem(),
				Mensagem.PALAVRA_CHAVE_INVALIDA.getMensagem());
		assertStringNaoVazia(atributo, Mensagem.ATRIBUTO_INVALIDO.getMensagem(),
				Mensagem.ATRIBUTO_INVALIDO.getMensagem());
		...
		UsuarioIF usuario = autenticacao.getUsuarioPeloIDSessao(idSessao);
		RefCoordenadas coordenadas = new RefCoordenadas(usuario.getLatitude(), usuario
				.getLongitude());
	...
	@Override
	public synchronized void devolverItem(String idSessao, String idEmprestimo) throws Exception {
		assertStringNaoVazia(idSessao, Mensagem.SESSAO_INVALIDA.getMensagem(),
				Mensagem.SESSAO_INVALIDA.getMensagem());
		asserteTrue(autenticacao.existeIdSessao(idSessao), Mensagem.SESSAO_INEXISTENTE
				.getMensagem());
	...
	@Override
	public synchronized void requisitarDevolucao(String idSessao, String idEmprestimo) throws Exception {
	...
	public String lerMensagens(String idSessao, String idTopico) throws Exception {
		...
		if (!usuario.equals(conversa.getRemetente())
			...
			throw new Exception(Mensagem.USUARIO_SEM_PERMISSAO_LEITURA_TOPICO
					.getMensagem());
	...
	public String pesquisarItem(String idSessao, String chave, String atributo,
		...
		assertStringNaoVazia(criterioOrdenacao, Mensagem.ORDENACAO_CRITERIO_INVALIDO
				.getMensagem(), Mensagem.ORDENACAO_CRITERIO_INVALIDO.getMensagem());
	...
	public void apagarItem(String idSessao, String idItem) throws Exception {
		...
		asserteTrue(item.estahDisponivel(), Mensagem.NAO_PODE_EMPRESTAR_ITEM_EMPRESTADO
				.getMensagem());
	...
	public String publicarPedido(String idSessao, String nomeItem, String descricaoItem) throws Exception {
		...
		assertStringNaoVazia(nomeItem, Mensagem.NOME_INVALIDO.getMensagem(),
				Mensagem.NOME_INVALIDO.getMensagem());
		assertStringNaoVazia(descricaoItem, Mensagem.DESCRICAO_INVALIDA.getMensagem(),
				Mensagem.DESCRICAO_INVALIDA.getMensagem());
		return autenticacao.getUsuarioPeloIDSessao(idSessao).publicarPedido(nomeItem,
				descricaoItem);
	}
	...
	public void oferecerItem(String idSessao, String idPublicacaoPedido, String idItem) throws Exception {
		...
		autenticacao.getUsuarioPeloIDSessao(idSessao).oferecerItem(idPublicacaoPedido,
				idItem);
	...
	public void republicarPedido(String idSessao, String idPublicacaoPedido) throws Exception {
		...
		asserteTrue(autenticacao.existeIdSessao(idSessao), Mensagem.SESSAO_INEXISTENTE
				.getMensagem());
		autenticacao.getUsuarioPeloIDSessao(idSessao)
				.republicarPedido(idPublicacaoPedido);
