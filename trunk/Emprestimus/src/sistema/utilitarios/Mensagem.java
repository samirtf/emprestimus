...
public enum Mensagem {
	...
	/* Especiais */
	NOME_PROJETO("Emprestimus"), BOAS_VINDAS("Bem vindo(a) ao Emprestimus! "), COPYRIGHT(
			"Copyright © 2010 Joeffison S. A. All rights reserved."), CONTATOS(
			"Deseja contratar nossos servicos?\n"
					+ "Entao envie um email para: joeffisonsa@gmail.com"), CREDITOS(
			"Copyright © 2010 Joeffison S. A. All rights reserved.\n\n"
					+ ""
					+ "Programadores: \n"
	...
	REENCAMINHAMENTO_AO_MENU_PRINCIPAL(
			"O sistema esta sendo reencaminhado ao menu principal."), 
	...
	/* Avisos */
	INFO_AGUARDE_APROVACAO_AMIZADE(
			"Usuario adicionado a sua lista de amizades pendentes.\n"
	...
	USUARIO_NAO_TEM_PERMISSAO_REQUISITAR_EMPREST_ITEM(
	...
	EMPRESTIMO_DEVOLUCAO_CONFIRMADA_APENAS_EMPRESTADOR(
