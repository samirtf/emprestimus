...
public class BancoDeEmprestimos {
	...
	public void adicionarRequisicaoEmprestimoEmEsperaDeAmigo(String login, EmprestimoIF emp) throws Exception{
		if(!contas.containsKey(login)) throw new Exception(Mensagem.PROPRIETARIO_CONTA_INEXISTENTE.getMensagem());
		contas.get(login).getEmprestimosRequeridosPorAmigosEmEspera().add(emp);
		//this.emprestimosRequeridosPorAmigosEmEspera.add(emp);
	}

	public synchronized String requisitarEmprestimo(String login, String idItem, int duracao) throws Exception{
		...
		Iterator<EmprestimoIF> iterador = contas.get(login).getEmprestimosRequeridosPorMimEmEspera().iterator();
		...
		contas.get(login).getEmprestimosRequeridosPorMimEmEspera().add(emp);// o emprestimo eh modificdo pelo repositorio possuindo agora
						// um id valido
		...
		usuario.enviarMensagemEmprestimo(amigo.getLogin(), assunto, mensagem, emp.getIdEmprestimo());
	...
	public String aprovarEmprestimo( String login, String idRequisicaoEmprestimo )
		...
		Autenticacao.getUsuarioPorLogin(login).addHistoricoEmprestimoEmAndamento(amigo, emp.getItem());
	...
	public void removerEmprestimosRequeridosPorAmigo( String login, UsuarioIF amigo) {
		...
		= contas.get(login).getEmprestimosRequeridosPorAmigosEmEspera().iterator();
	...
	public void removerEmprestimosRequeridosPorMim(String login, UsuarioIF amigo) {
		...
		= contas.get(login).getEmprestimosRequeridosPorMimEmEspera().iterator();
	...
	public synchronized boolean requisiteiEsteItem(String login, String idItem) throws Exception {
		...
		Iterator<EmprestimoIF> iteradorEmprestimos = contas.get(login).getEmprestimosRequeridosPorMimEmEspera().iterator();
