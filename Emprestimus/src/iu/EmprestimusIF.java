...
public interface EmprestimusIF {
	 ...
	 * nova sessão para este.
	 * 
	 * @param login
	 *            Login do usuário a ser logado.
	 * @return ID da sessão aberta (que será anulado ao deslogar).
	 * @throws Exception
	 *             Caso o usuário já esteja logado ou o login seja
	 ...
	 * @return Uma {@link String} representando os usuários (nome e endereço)
	 *         que atendem à pesquisa.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inexistente.
	 */
	 ...
	 * 
	 * @param idSessao
	 *            ID da sessão do usuário que deseja visualizar as requisitações
	 *            de sua amizade.
	 * @return O login de todos os usuários que requisitaram amizade ao usuário
	 *         que fez a verificação.
	 * @throws Exception
	 ...
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente ou não
	 *             exista a requisitação.
	 */
	 ...
	 * @param login
	 *            Login do usuário a ser verificado na lista de amigos do
	 *            usuário que fez a verificação.
	 * @return Retorna "true", caso sejam amigos, ou "false", caso não.
	 * @throws Exception
	 ...
	 * @return Logins dos amigos do usuário requisitante.
	 * @throws Exception
	 *             Caso o ID da sessão seja inválido/inexistente.
	 */
	 ...
	 * 
	 * @param idSessao
	 *            Id da sessão do usuário que deseja recuperar a lista de amigos
	 *            do outro usuário.
	 * @param login
	 *            Login do usuário que terá sua lista de amigos verificada.
	 * @return Logins dos amigos do usuário com o login informado.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @param idSessao
	 *            ID da sessão do usuário que deseja fazer a verificação.
	 * @return Nome dos itens do usuário.
	 * @throws Exception
	 ...
	 * @return Nome dos itens do usuário com o login informado.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @return ID da requisitação do empréstimo.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @return ID do empréstimo aprovado.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @return Lista com a representação de todos os empréstimos.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @return ID do tópico da mensagem.
	 * @throws Exception
	 ...
	 * devem ser recuperados (negociação, off-topic ou todos).
	 * 
	 * @param idSessao
	 *            ID da sessão do usuário que deseja fazer a verificação.
	 * @param tipo
	 *            Tipo de tópico desejado (negociação, off-topic ou todos).
	 * @return Lista de tópicos requirida do usuário, ordenada pela data de
	 *         criação, do tópico mais recente ao mais antigo.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * @return Lista de mensagens relativa a um tópico, ordenada pela data de
	 *         criação, da mensagem mais antiga à mais recente.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	 ...
	 * 
	 * @param idSessao
	 *            ID da sessão do usuário que deseja registrar interesse no
	 *            item.
	 * @param idItem
	 ...
	 * @return String que representa o ranking.
	 * @throws Exception
	 *             Caso algum dos parâmetros seja inválido/inesxistente.
	 */
	...
	// US15
	/**
	 * Permite que o usuário veja as atividades realizadas em ordem de
	 * ocorrência (da atividade mais recente à mais antiga).
	 * 
	 * @param idSessao
	 *            ID da sessão do usuário que deseja visualizar o histórico.
	 * @return String que representa o historico solicitado.
	 * @throws Exception
	...
	// US16
	/**
	 * Permite que o usuário visualize suas atividades em conjunto com as
	 * atividades passadas dos seus amigos (da atividade mais recente à mais
	 * antiga). As atividades consideradas do método acima. Note que não existe
	 * a duplicação da atividade “adição de amigo concluída”, portanto mostra
	 * apenas a atividade do usuario que requisitou o histórico de atividades em
	 * conjunto.
	 * 
	 * @param idSessao
	 *            ID da sessão do usuário que deseja visualizar o histórico.
	...
	// US17
	/**
	 * Publica um pedido de item cujos nome e descrição batam com os passados
	 * como parâmetro.
	 * 
	 * @param idSessao
	 ...
	 * @return ID da publicação do pedido.
	 * @throws Exception
	...
	// US20
	/**
	 * Localiza os usuários que moram perto do usuário com o id de sessão
	 * informado.
	 * 
	 * @param idSessao
	 *            Id da sessão do usuário que servirá como ponto de referência
	 *            (usuário base) para localizar os demais.
	 * @return Uma String que agrupa o nome e o endereço dos usuários que moram
	 *         perto do usuário base.
	 * @throws Exception
	 *             Caso o parâmetro passado seja inválido ou inexistente.
	 */
