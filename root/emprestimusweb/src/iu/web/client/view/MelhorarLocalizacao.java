...
public class MelhorarLocalizacao extends Composite {
	...
	public MelhorarLocalizacao(Controlador controlador) {
	...
	private void setPainelMural() {
		...
		Label label = new Label("Melhorar Localização de Usuários");
		label.setStyleName("nathaniel2");
		painelMural.add(label, 128, 29);
		label.setSize("674px", "53px");
		...
		HTML htmlNome = new HTML("Usuários ordenados por proximidade com sua localização", true);
		painelCentral.add(htmlNome, 289, 137);
		htmlNome.setSize("362px", "18px");
	}
