...
import iu.web.server.sistema.dao.*;
 ...
 * @version 1.0
 */
public class Emprestimus2 implements EmprestimusIF2 {
	private static Emprestimus2 emprestimus;
	 ...
	 */
	public synchronized static Emprestimus2 getInstance() {

		if (emprestimus == null) {
			emprestimus = new Emprestimus2();
