 ...
 * @version 1.0
 */
public class Emprestimus1 implements EmprestimusIF1 {
	
	private static Emprestimus1 emprestimus;
	 ...
	 */
	public synchronized static Emprestimus1 getInstance() {

		if (emprestimus == null) {
			emprestimus = new Emprestimus1();
