	...
	public void testarCadastrarItem() {
		...
		try {
			...
			try {
				...
				Assert.assertEquals(
						"1 4 5 7 10 13 16 19 22 25 28 31 34 37 40 43 46 49 52 55 58 61 64 67 70 73 76 79 82 85 88 91 94",
						us1.getListaIdItens());
				Assert.assertEquals(
						"2 6 8 11 14 17 20 23 26 29 32 35 38 41 44 47 50 53 56 59 62 65 68 71 74 77 80 83 86 89 92 95",
						us2.getListaIdItens());
				Assert.assertEquals(
